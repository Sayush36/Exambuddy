...
import { BookOpen, CreditCard, FileText, GraduationCap, LayoutDashboard, LogOut, Menu, Settings, Trophy, Briefcase } from "lucide-react";
...
const sidebarItems = [
    ...
    { href: "/dashboard/placement-material", icon: Briefcase, label: "Placement Material" },
